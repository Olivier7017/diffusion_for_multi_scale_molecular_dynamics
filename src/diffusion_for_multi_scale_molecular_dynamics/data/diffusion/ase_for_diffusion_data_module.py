...
class ASEForDiffusionDataModuleParameters(DataModuleParameters):
    ...
    data_type: str = "Trajectory"  # LAMMPS or Trajectory for now
...
class ASEForDiffusionDataModule(pl.LightningDataModule):
    ...
    def __init__(
        ...
        train_trajectory_list: list[str] = None,
        validation_trajectory_list: list[str] = None,
        working_cache_dir: Optional[str] = None,
    ):
        """Initialize a dataset of structures for training a diffusion model.

        Args:
            processed_dataset_dir: folder where to store processed data,
            hyper_params: hyperparameters,
            train_trajectory_list: list of str pointing to the ase.Trajectory for training purpose
            validation_trajectory_list: list of str pointing to the ase.Trajectory for validation purpose
