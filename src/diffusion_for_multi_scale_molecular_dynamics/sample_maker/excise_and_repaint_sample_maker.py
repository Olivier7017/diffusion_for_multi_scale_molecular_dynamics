...
from diffusion_for_multi_scale_molecular_dynamics.sample_maker.atom_selector.base_atom_selector import \
    BaseAtomSelector
...
from diffusion_for_multi_scale_molecular_dynamics.sample_maker.excisor.base_excisor import \
