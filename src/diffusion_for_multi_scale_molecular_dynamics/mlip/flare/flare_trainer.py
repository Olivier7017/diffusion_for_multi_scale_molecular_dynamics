...
class FlareTrainer(BaseMLIPTrainer):
    ...
    def write_lammps_potential(self, output_directory: Path) -> FlarePotential:
        """Write the mapped LAMMPS files into output_directory and return the matching FLARE potential."""
    ...
    def write_checkpoint(self, checkpoint_path: Path):
