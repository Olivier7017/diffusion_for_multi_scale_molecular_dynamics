...
class LammpsInputBuilder:
    ...
    def build_single_point(
        ...
        Args:
            ...
            dump_filename: name of the yaml dump file the results are written to.
    ...
    def build_looping_single_point(
        ...
        own dump); consecutive blocks are separated by 'clear', which resets LAMMPS between configurations.
        ...
        Args:
            ...
            dump_filenames: the yaml dump file written for each structure (same length as structures).
            with_uncertainty: whether to compute the per-atom uncertainty.
        ...
        blocks = [
            ...
            for structure, configuration_filename, dump_filename in zip(
                structures, configuration_filenames, dump_filenames
            )
        ]
