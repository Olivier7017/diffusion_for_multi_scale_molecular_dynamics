from diffusion_for_multi_scale_molecular_dynamics.diffusion_model.loss.atom_type_loss_calculator import \
    D3PMLossCalculator
from diffusion_for_multi_scale_molecular_dynamics.diffusion_model.loss.coordinates_loss_calculator import (
